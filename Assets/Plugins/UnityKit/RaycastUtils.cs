...
public static class RaycastUtils {
	...
	public static Tuple<Vector3, float, Vector3> averageRaycast(Vector3 start, Vector3 end, Vector3 up, int steps, int layerMask, float raycastDist, bool debug)
	{
		int hits = 0;
		...
		return new Tuple<Vector3, float, Vector3>(avgPoint, avgDistance, avgNormal);
	}	
}
